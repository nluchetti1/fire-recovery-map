...
# 1. Print immediately to confirm script started
...
def download_latest_vhi():
    ...
    # Satellites to check: j01 (NOAA-20) and npp (Suomi NPP backup)
    satellites = ['j01', 'npp']
...
def plot_vhi(tif_path, date_str):
    ...
    try:
        with rasterio.open(tif_path) as src:
            ...
            # Robust Window Rounding (Fixes deprecation warnings)
